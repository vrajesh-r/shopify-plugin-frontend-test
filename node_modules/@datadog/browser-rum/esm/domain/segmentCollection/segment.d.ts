...
export declare class Segment {
    ...
    constructor(worker: DeflateWorker, context: SegmentContext, creationReason: CreationReason, initialRecord: Record, onWrote: (size: number) => void, onFlushed: (data: Uint8Array, rawSize: number) => void);
