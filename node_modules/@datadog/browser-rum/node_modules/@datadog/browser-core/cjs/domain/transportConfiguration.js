...
function computeTransportConfiguration(initConfiguration, buildEnv) {
    var transportSettings = {
        ...
        site: initConfiguration.site || exports.INTAKE_SITE[initConfiguration.datacenter || buildEnv.datacenter],
    ...
    if (transportSettings.buildMode === init_1.BuildMode.STAGING) {
        if (initConfiguration.replica !== undefined) {
            var replicaTransportSettings = tslib_1.__assign(tslib_1.__assign({}, transportSettings), { applicationId: initConfiguration.replica.applicationId, clientToken: initConfiguration.replica.clientToken, site: exports.INTAKE_SITE[exports.Datacenter.US] });
...
function getIntakeType(site, initConfiguration) {
    return !initConfiguration.useAlternateIntakeDomains && utils_1.includes(CLASSIC_ALLOWED_SITES, site) ? 'classic' : 'alternate';
}
